...
public class TransactionLoggingAspect {
    ...
    public Object logTransaction(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.info("Transaction {} - Method {} executed successfully. Response: {}", transactionId, methodName,
                    result);
            return result;
        } catch (Exception e) {
            log.error("Transaction {} - Method {} failed with exception: {}", transactionId, methodName,
                    e.getMessage());
            throw e;
        } finally {
